...
class HelloApiTest {
    ...
    void helloApi() {
        ...
        ResponseEntity<String> ret = restTemplate.getForEntity("http://localhost:9091/app/hello?name={name}", String.class, "dukim");
        // status code 200
    ...
    void failsNullHelloApi() {
        // http localhost:8080/hello?name=Spring
        TestRestTemplate restTemplate = new TestRestTemplate();
        ResponseEntity<String> ret = restTemplate.getForEntity("http://localhost:9091/app/hello?name=", String.class);
        // status code 200
    ...
    void failsEmptyHelloApi() {
        // http localhost:8080/hello?name=Spring
        TestRestTemplate restTemplate = new TestRestTemplate();
        ResponseEntity<String> ret = restTemplate.getForEntity("http://localhost:9091/app/hello?name={name}", String.class, "");
        // status code 200
        assertThat(ret.getStatusCode()).isEqualTo(HttpStatus.INTERNAL_SERVER_ERROR);
    }
